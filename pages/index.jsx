    ...
    return (
        <Layout>
            ...
            <ProjectSection title="Libraries &amp; Apps" delay={0.3} id="projects">
                <motion.div className="row row-split-content" variants={itemVariants}>
                    <h3 className="display-sm"><a href="https://ccreward.app/" target="_blank" rel="noopener noreferrer" className="link-no-underline">ccreward.app</a></h3>
                ...
                <motion.div className="row row-split-content" variants={itemVariants}>
                    <h3 className="display-sm"><a href="https://www.npmjs.com/package/airport-data-js" target="_blank" rel="noopener noreferrer" className="link-no-underline">airport-data-js</a></h3>
            ...
            <ProjectSection title="Bounties" delay={0.4} id="bounties">
                <motion.div className="row row-split-content" variants={itemVariants}>
                    ...
                    <p className="paragraph">Ranked 2nd in Singapore and 907th globally on the Bug Hunters Leaderboard for identifying a significant privacy issue, classified as Priority P2 and Severity S2, with details currently under private disclosure.<br /></p>
                </motion.div>
